...
#if defined(__STATE_MANAGER_DEVICE_FIX__)
	SetDefaultState();
#else
	D3DCAPS8 d3dCaps;
...
void CStateManager::SetDefaultState()
{
	...
	SetRenderState(D3DRS_FOGSTART, FALSE);
	SetRenderState(D3DRS_FOGEND, FALSE);
	SetRenderState(D3DRS_FOGDENSITY, FALSE);
	SetRenderState(D3DRS_EDGEANTIALIAS, FALSE);
	SetRenderState(D3DRS_ZBIAS, FALSE);
