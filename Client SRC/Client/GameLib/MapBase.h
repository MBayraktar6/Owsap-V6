...
public:
	...
	struct SSungmaAttr { int str, hp, move, immune; };
#endif
...
#if defined(ENABLE_CONQUEROR_LEVEL)
	bool LoadSungMaAttr();
	bool HasSungMaAttr() const;
	const SSungmaAttr& GetSungMaAttrData() const;
#endif
...
#if defined(ENABLE_CONQUEROR_LEVEL)
	bool m_bHasSungmaAttr;
	SSungmaAttr m_kSungmaAttr;
#endif
};
