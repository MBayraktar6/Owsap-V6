...
public:
	...
	enum EParts
	{
		...
		// ECharacterEquipmentPart 도 수정해주세요.
...
public:
	...
	bool GetFlyTargetAdjustPosition(D3DXVECTOR3* v3Position) const;
...
protected:
	...
	bool m_bHasFlyTargetAdjustPosition;
	D3DXVECTOR3 m_v3FlyTargetAdjustPosition;
