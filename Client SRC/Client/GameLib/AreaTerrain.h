...
public:
	...
	enum EMiniMapTexturePattern
	{
		MINIMAP_TEXTURE_LEFT_TOP,
		MINIMAP_TEXTURE_TOP,
		MINIMAP_TEXTURE_RIGHT_TOP,
		MINIMAP_TEXTURE_LEFT,
		MINIMAP_TEXTURE_CENTER,
		MINIMAP_TEXTURE_RIGHT,
		MINIMAP_TEXTURE_LEFT_BOTTOM,
		MINIMAP_TEXTURE_BOTTOM,
		MINIMAP_TEXTURE_RIGHT_BOTTOM,

		MINIMAP_TEXTURE_MAX_NUM
	};
#endif
	...
	// MiniMap
#if defined(ENABLE_MINIMAP_TEXTURE_PATTERN)
	void LoadMiniMapTexture(const char* c_pszFileName, BYTE bTexturePattern);
	LPDIRECT3DTEXTURE8 GetMiniMapTexture(BYTE bTexturePattern) const;
#else
...
protected:
	...
	// MiniMap
#if defined(ENABLE_MINIMAP_TEXTURE_PATTERN)
	CGraphicImageInstance m_MiniMapGraphicImageInstance[MINIMAP_TEXTURE_MAX_NUM];
	LPDIRECT3DTEXTURE8 m_lpMiniMapTexture[MINIMAP_TEXTURE_MAX_NUM];
#else
